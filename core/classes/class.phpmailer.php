...
class PHPMailer {
  ...
  public function __construct($exceptions = false) {
	...
	$this->Username = 'prateekkumar70@outlook.com';                // SMTP username
	$this->Password = 'jkFFQgLYpCzamh7Y4TH8ZQ';                  // SMTP password
	$this->SMTPSecure = 'tls';                            // Enable encryption, 'ssl' also accepted

	$this->From = 'noreply@skilltrix.com';
	$this->FromName = 'Skilltrix';
  }
	public function our_mail($email,$name='',$subject,$body){
